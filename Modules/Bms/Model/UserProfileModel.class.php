 ...
 * 会员模型
 */
class UserProfileModel extends BmsBaseModel {
    ...
    public function getList($param = []) {
        ...
        //生成ID查询条件
        $param  = $this->specialSearch($param, $Page, 'user_profile');
        //获取数据
    ...
    public function findRow($param = []) {
        return $this->alias('user_profile')->field('user_profile.*')->where($param['where'])->find();
    }
}