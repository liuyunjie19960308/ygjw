 ...
 * 
 */
class ReviewModel extends BmsBaseModel
{
    ...
    public function _initialize() {
        ...
        $this->_validate = [
            ...
            ['cover', 'require', '请上传封面！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH],
            //['content', 'require', '请编辑详细内容！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH],
    ...
    public function getList($param = [])
    {
        ...
        $list   = $this->alias('review')
                       ->field('review.id,review.title,review.short_desc,review.cover,review.sort,review.update_time,review.status')
