...
class PluginsModel extends BmsBaseModel {
    ...
    protected $_validate = array (
        ...
        array('name', '1,30', '插件标识长度不能超过30个字符！', self::EXISTS_VALIDATE, 'length', self::MODEL_BOTH),
        ...
        array('title', '1,30', '插件标题长度不能超过30个字符！', self::EXISTS_VALIDATE, 'length', self::MODEL_BOTH),
