 ...
 * 
 */
class MaterialModel extends BmsBaseModel
{
    ...
    public function _initialize() {
        //自动验证规则
        $this->_validate = [
            ['cate', 'require', '请选择栏目！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH],
            ['pc_show', 'require', '请上传素材图！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH],
    ...
    public function getList($param = [])
    {
        ...
        //生成ID查询条件
        $param  = $this->specialSearch($param, $Page, 'material');
        //获取数据
        $list   = $this->alias('material')
                       ->field('material.id,material.cate,material.pc_show,material.wap_show,material.sort,material.update_time,material.status')
