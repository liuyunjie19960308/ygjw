...
class AdministratorModel extends BmsBaseModel {
    ...
    protected $_validate = array (
        array('account', 'require', '账号未填写！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        array('account', '/^[a-zA-Z]\w{0,39}$/', '账号不合法！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        ...
        array('auth_group_id', 'require', '您未选择分组！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
    );
