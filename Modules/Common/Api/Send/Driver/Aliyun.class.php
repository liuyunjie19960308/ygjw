...
require_once './ThinkPHP_3.2.3/Library/Vendor/aliyun/vendor/autoload.php';
 ...
 * 备注:Demo工程编码采用UTF-8
 */
class Aliyun extends \Common\Api\Send\Sms{
    ...
    public function _initialize($options) {
        $this->templateCode  = $options['template_code'];
        $this->param         = $options['replaces'];
...
//        $request->setSmsUpExtendCode("1234567");
        ...
        $json_acsResponse = (array)($acsResponse);
        if ($json_acsResponse['Message'] == 'OK'){
            return true;
        }
        return $acsResponse;
    }
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI7UU1H1EZcOX9"; // AccessKeyId

        $accessKeySecret = "KcjbLCDMYaGATWOYQuRLBvpce2QNcH"; // AccessKeySecret
