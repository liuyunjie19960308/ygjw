...
class DefaultAcsClient implements IAcsClient
{
    ...
    {
        return new ServerException($respObject->Message, $respObject->Code, $httpStatus, $respObject->RequestId);//20190417 抛出改为返回异常
        // throw new ServerException($respObject->Message, $respObject->Code, $httpStatus, $respObject->RequestId);//原
    }
