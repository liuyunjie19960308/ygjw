        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-title widget-title-search list-widget-title">
                    <button class="btn btn-success href" url="<?php echo U('Hstory/Hstory_add');?>" target-form="ids">新增</button>&nbsp;
                    <!--<button class="btn btn-inverse ajax-post" url="<?php echo U('Hstory/statusAll',array('value'=>2));?>" target-form="ids">禁用</button>&nbsp;-->
                    <!--<button class="btn btn-info ajax-post" url="<?php echo U('Hstory/statusAll',array('value'=>1));?>" target-form="ids">启用</button>&nbsp;-->
                    <button class="btn btn-danger confirm ajax-post" url="<?php echo U('Hstory/deleteAll');?>" target-form="ids">删除</button>&nbsp;
                ...
                <div class="widget-content no-padding no-border">
                    <table class="table table-bordered table-striped with-check reset-checkbox">
                        ...
                        <tr>
                            ...
                            <th>ID</th>
                            <th><i class="fa fa-pencil"></i>年份</th>
                            <th>历史介绍</th>
                            <th>操作</th>
                        </tr>
                        </thead>
                        ...
                        <?php foreach($list as $v):?>
                            ...
                            <td align="left">
                                <?php echo $v['title'];?>                </td>
                                <td>
                                    <a href="<?php echo U('Hstory/desc',array('id'=>$v['id']));?>" title="编辑" class="tip-bottom">
                                        <span class="label label-success label-success-hover">编辑</span></a>&nbsp;
                                    <!--<?php if($v['status'] == 2 or $v['status'] == 1): ?>-->
                                        <!--<a href="<?php echo U('Hstory/statusOne',array('value'=>$v['status'],'id'=>$v['id']));?>" title="<?php echo (show_status_name($v['status'])); ?>" class="tip-bottom ajax-get">-->
                                            <!--<span class="label <?php echo (show_status_label($v['status'])); ?>"><?php echo (show_status_name($v['status'])); ?></span></a>&nbsp;-->
                                    <!--<?php endif; ?>-->

                                    <a href="<?php echo U('Hstory/deleteOne',array('ids'=>$v['id']));?>" data-ing-html="正在删除 <i class='fa fa-spinner fa-spin'></i>" title="删除" class="tip-bottom confirm ajax-get">
