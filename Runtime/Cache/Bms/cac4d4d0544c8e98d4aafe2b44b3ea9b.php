        ...
        <form class="layui-form">
            ...
            <div class="layui-upload" style="margin-left: 110px">
                <div class="controls">
                    ...
                    <span class="help-block">* 公司图片 </span>
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-inline">
                    ...
                    <?php echo hook('adminArticleEdit', array('is_first'=>1,'name'=>'content','value'=>$list['content'],'width'=>910,'height'=>500));?>
                </div>
            </div>
    ...
    <script>
        ...
        layui.use(['layer', 'form','upload'], function(){
            ...
            form.on('submit(update)', function(data){
                $.post("<?php echo U('Introduce/introduce_update');?>",$(data.form).serialize(),
                    function(res){
                        if(res.code==200){
                            layer.alert(res.msg, {icon: 6},function () {
                                window.location.href="<?php echo U('Introduce/introduce_index');?>";
                            });
                        }
                        if(res.code==201){
