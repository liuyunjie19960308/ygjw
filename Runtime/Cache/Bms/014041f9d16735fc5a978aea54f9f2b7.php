                            ...
                            <div class="controls">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group_row): $mod = ($i % 2 );++$i;?><li data-value="<?php echo ($group_row['id']); ?>" data-title="<?php echo ($group_row['name']); ?>" <?php if(($group_row['id']) == $row['auth_group_id']): ?>class="selected"<?php endif; ?>>
                                            <a href="javascript:void(0)"><?php echo ($group_row['name']); ?></a>
                                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </ul>
                                </div>
                                <input type="hidden" name="auth_group_id" value="<?php echo ($row['auth_group_id']); ?>">
