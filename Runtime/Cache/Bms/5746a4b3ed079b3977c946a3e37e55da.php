...
<div class="alert alert-error" style="display: none">
    ...
    <div class="x-body" style="margin: 50px">
        <form class="layui-form">
            ...
            <?php echo hook('adminArticleEdit',array('is_first'=>1,'name'=>'enterprise_statement_content','value'=>$list['enterprise_statement_content'],'width'=>910,'height'=>500));?> 
                </div>
            </div>
    ...
    <link rel="stylesheet" href="/Public/Bms/KindEditor/themes/default/default.css" />
    <script charset="utf-8" src="/Public/Bms/KindEditor/kindeditor-all-min.js"></script>
    <script charset="utf-8" src="/Public/Bms/KindEditor/kindeditor-all.js"></script>
    <script charset="utf-8" src="/Public/Bms/KindEditor/lang/zh-CN.js"></script>
    <script charset="utf-8" src="/Public/Bms/KindEditor/KindEdi/plugins/code/prettify.js"></script>
    <script>
    ...
    <script>
        ...
        layui.use(['layer', 'form'], function(){
            ...
            form.on('submit(update)', function(data){
                $.post("<?php echo U('Policy/statement_update');?>",$(data.form).serialize(),
                    function(res){
                        if(res.code==200){
                            layer.alert(res.msg, {icon: 6},function () {
                                window.location.href="<?php echo U('Policy/statement_info');?>";
                            });
                        }
                        if(res.code==201){
