        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-title widget-title-search list-widget-title">
                    ...
                    <button class="btn btn-inverse ajax-post" url="<?php echo U('Article/forbidResume',array('model'=>'Article','field'=>'status','value'=>0));?>" target-form="ids">禁用</button>&nbsp;
                    <button class="btn btn-info ajax-post" url="<?php echo U('Article/forbidResume',array('model'=>'Article','field'=>'status','value'=>1));?>" target-form="ids">启用</button>&nbsp;
                    ...
                    <table class="table table-bordered table-striped with-check reset-checkbox">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    ...
                                    <!--<a href="<?php echo U('Article/update',array('id'=>$row['id'],'flag'=>'gl'));?>" title="关联商品" class="tip-bottom">
                                        <span class="label label-primary label-primary-hover">关联商品</span></a>&nbsp;-->
                                    <?php if($row['status'] == 0 or $row['status'] == 1): ?><a href="<?php echo U('Article/forbidResume',array('model'=>'Article','ids'=>$row['id'],'field'=>'status','value'=>abs(1-$row['status'])));?>" title="<?php echo (show_status_name($row['status'])); ?>" class="tip-bottom ajax-get">
