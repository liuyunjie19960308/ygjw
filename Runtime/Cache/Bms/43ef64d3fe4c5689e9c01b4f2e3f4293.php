    ...
    <div class="x-body" style="margin: 50px">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                <label for="Journalism_title" class="layui-form-label">
                    <span class="x-red">*</span>新闻标题
                </label>
                <div class="layui-input-inline">
                    <input type="text" id="Journalism_title" name="journalism_title" value="<?php echo $list['journalism_title'];?>" required="" lay-verify="required"
           ...
           <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-inline">
                                <textarea name="journalism_content"><?php echo $list['journalism_content']; ?></textarea>
        <?php echo hook('adminArticleEdit',array('is_first'=>1,'name'=>'journalism_content','value'=>$list['journalism_content'],'width'=>910,'height'=>500));?> 
                </div>
            </div>
    ...
    <script>
        ...
        layui.use(['layer', 'form'], function(){
            ...
            form.on('submit(update)', function(data){
                $.post("<?php echo U('Journalism/update');?>",$(data.form).serialize(),
                    function(res){
                        if(res.code==200){
                            layer.alert(res.msg, {icon: 6},function () {
                                window.location.href="<?php echo U('Journalism/lists');?>";
                            });
                        }
                        if(res.code==201){
