    ...
    <div class="x-body" style="margin: 50px">
        <form class="layui-form">
            ...
            <div class="layui-upload" style="margin-left: 110px">
                <div class="controls">
            <?php echo hook('upload',array('is_first'=>1,'unique_sign'=>'banner_image_img','field_name'=>'banner_image_img','field_value'=>$list['banner_image_img'],'save_path'=>'News'));?>
                ...
                <script>
                    ...
                    //自定义验证规则
                        ...
                        form.on('submit(add)', function(data){
                            $.post("<?php echo U('Banner/add');?>",$(data.form).serialize(),
                                function(res){
                                    if(res.code==200){
