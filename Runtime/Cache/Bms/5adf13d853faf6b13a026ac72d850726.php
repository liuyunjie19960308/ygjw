...
<?php echo hook('upload',array('is_first'=>1,'queue_limit'=>5,'unique_sign'=>'pictures','field_name'=>'pictures','field_value'=>$row['pictures'],'save_path'=>'logo-dp','is_oss'=>1));?>
                <ul class="stat-boxes">
                ...
                <div class="widget-content">
                    <div class="row-fluid">
                        <div class="span6">
                            <?php echo hook('statistics', ['is_first'=>1,'chart_id'=>'line-container1','chart_type'=>'spline','chart_data'=>$member_day_quantity_line,'core_content'=>1,'y_title_text'=>'quantity']);?>
                        </div>
                        <div class="span6">
                            <?php echo hook('statistics', ['chart_id'=>'line-container2','chart_type'=>'spline','chart_data'=>$shop_day_quantity_line,'core_content'=>1,'y_title_text'=>'quantity']);?>
                       </div>
                    </div>
                </div>
            </div>
