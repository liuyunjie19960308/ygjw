    ...
    <div class="x-body" style="margin: 50px">
        <form class="layui-form">
          ...
          <div class="layui-form-item layui-form-text">
            ...
            <?php echo hook('adminArticleEdit', array('is_first'=>1,'name'=>'policy_statement_content','value'=>$list['policy_statement_content'],'width'=>910,'height'=>500));?> 
                </div>
            </div>
    ...
    <script>
        ...
        layui.use(['layer', 'form'], function(){
            ...
            form.on('submit(update)', function(data){
                $.post("<?php echo U('Policy/policy_update');?>",$(data.form).serialize(),
                    function(res){
                        if(res.code==200){
                            layer.alert(res.msg, {icon: 6},function () {
                                window.location.href="<?php echo U('Policy/policy_info');?>";
                            });
                        }
                        if(res.code==201){
