    ...
    <div class="x-body" style="margin: 50px">
        <form class="layui-form">
            ...
            <div class="layui-upload" style="margin-left: 110px">
                <div class="controls">
                    <?php echo hook('upload',array('is_first'=>1,'unique_sign'=>'images','field_name'=>'images','field_value'=>$list['images'],'save_path'=>'News'));?>
                    <span class="help-block">* 城市图片 </span>
                </div>
            </div>

            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                    <span class="x-red">*</span>城市名
                </label>
            ...
            <div class="layui-form-item">
                <label for="customer" class="layui-form-label">
                    <span class="x-red">*</span>客户服务电话
                </label>
                <div class="layui-input-inline">
                    <input type="text" id="customer" name="customer" required="" lay-verify="customer"
                           autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>
                ...
                <script>
                    ...
                    //     });
                        ...
                        form.on('submit(add)', function(data){
                            $.post("<?php echo U('EnterpriseContact/add');?>",$(data.form).serialize(),
                                function(res){
                                    if(res.code==200){
                                        layer.alert(res.msg, {icon: 6},function () {

                                            window.location.href="<?php echo U('EnterpriseContact/lists');?>";
                                        });
                                    }
                                    if(res.code==201){
