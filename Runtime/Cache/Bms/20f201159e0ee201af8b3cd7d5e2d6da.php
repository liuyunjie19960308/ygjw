        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-title widget-title-search list-widget-title">
                    <button class="btn btn-success href" url="<?php echo U('Hooks/add');?>" target-form="ids">新增</button>&nbsp;
                </div>
                ...
                <div class="widget-content no-padding no-border">
                    <table class="table table-bordered table-striped">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo (get_config_title($row['type'],HOOKS_TYPE)); ?></td>
                                <td>
                                    <a href="<?php echo U('Hooks/update',array('id'=>$row['id'],'model'=>'Hooks'));?>" title="编辑" class="">
                                        <span class="label label-success label-success-hover">编辑</span></a>&nbsp;
                                    <a href="<?php echo U('Hooks/delete',array('model'=>'Hooks','ids'=>$row['id']));?>" class="confirm ajax-get" title="删除" class="tip-bottom">
