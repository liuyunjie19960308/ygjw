    ...
    <div class="x-body" style="margin: 50px">
        <form class="layui-form">
            ...
            <div class="layui-upload" style="margin-left: 110px">
                <div class="controls">
                    <?php echo hook('upload',array('is_first'=>1,'queue_limit'=>20,'unique_sign'=>'pictures','field_name'=>'images','field_value'=>$list['images'],'save_path'=>'News'));?>
    ...
    <script>
        ...
        layui.use(['form','layer','upload'], function(){
            ...
            form.on('submit(save)', function(data){
                $.post("<?php echo U('Cooperation/update');?>",$(data.form).serialize(),
                    function(res){
                        if(res.code==200){
                            layer.alert(res.msg, {icon: 6},function () {

                                window.location.href="<?php echo U('Cooperation/lists');?>";
                            });
                        }
                        if(res.code==201){
